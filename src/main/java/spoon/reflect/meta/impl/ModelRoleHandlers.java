...
class ModelRoleHandlers {
	...
	static class CtRecord_PARAMETER_RoleHandler extends ListHandler<CtRecord, CtParameter<?>> {
		private CtRecord_PARAMETER_RoleHandler() {
			super(CtRole.PARAMETER, CtRecord.class, CtParameter.class);
		}
